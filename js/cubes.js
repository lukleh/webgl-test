...
(function() {
  var Cube, CubeRot, CubeSpin, Object3D, Space, makeCombinations, makeGrid, printout, run_cubes, _ref,
  ...
  Cube = (function(_super) {
    ...
    Cube.prototype.makeMaterials = function() {
      ...
      for (i = _i = 0; _i <= 5; i = ++_i) {
        _results.push(new THREE.MeshPhongMaterial({
  ...
  CubeSpin = (function(_super) {
    ...
    CubeSpin.prototype.update = function(t_step, timestamp) {
      ...
      return CubeSpin.__super__.update.call(this, t_step, timestamp);
    };
